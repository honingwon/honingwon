package sszt.exStore.component.secs
{
	 ...
	 * 
	 */	
	public class ShenMuPanel extends Sprite implements IExStorePanel
	{
		...
		public function ShenMuPanel(type:int,mediator:ExStoreMediator)
		{
			super();
			_mediator = mediator;
			_shopType = type;
		...
		private function initView():void
		{
			...
			_pageView.totalRecord = ShopTemplateList.getShopByCareer(_shopType,GlobalData.selfPlayer.career).shopItemInfos[0].length;
		...
		{
			clearCell();
			var shop:ShopTemplateInfo = ShopTemplateList.getShopByCareer(_shopType,GlobalData.selfPlayer.career);
