...
insert  into `bm_goods`(`goods_id`,`account_id`,`brand_id`,`type3_id`,`goods_barcode`,`goods_name`,`goods_unit`,`goods_weight`,`goods_active_stime`,`goods_active_etime`,`goods_pic_url`,`goods_state`,`goods_number`,`goods_price`,`goods_active_price`,`goods_remark`) values (1,1,1,1,9001,'上好佳 沐浴露','个','1',2,3,'/view/cst/upload/531691fe8324e.jpg',0,9982,5,1,'123'),(2,1,2,10,9002,'大好大六神','个','1',2,3,'/view/cst/upload/5316c5c2bc064.jpg',0,9995,3,2,'123'),(3,1,1,1,1,'2','2','3',4,5,'/view/cst/upload/53192716df614.jpg',0,0,3,45,'5'),(4,1,1,1,1,'2','2','3',4,5,'/view/cst/upload/53192716df614.jpg',0,1,3,45,'5');
...
insert  into `bm_purchase_info`(`shopping_cart_id`,`purchase_id`,`goods_id`,`goods_num`,`goods_active_etime`,`purchase_goods_price`,`purchase_state`) values (1,1,1,2,0,5,0),(2,1,2,1,0,3,0),(3,2,1,2,0,5,0),(4,2,2,1,0,3,0),(5,3,1,2,0,5,0),(6,3,2,1,0,3,0),(7,4,1,1,0,5,0),(8,4,2,1,0,3,0),(9,4,3,1,0,3,0);
...
insert  into `bm_purchase_list`(`purchase_id`,`account_id`,`shop_id`,`add_time`,`purchase_state`,`return_time`,`purchase_price`,`purchase_remark`) values (1,1,1,1394001391,98,0,0,'123'),(2,1,1,1394002773,0,0,0,'123'),(3,1,1,1394070948,0,0,0,'123'),(4,1,1,1394158692,0,0,0,'123');
...
insert  into `bm_store_info`(`shop_id`,`account_id`,`shop_name`,`shop_province`,`shop_city`,`shop_district`,`shop_addr`,`shop_contacts`,`shop_phone`,`shop_state`) values (1,1,'白马湖超市','浙江省','杭州市','滨江区','白马湖002','联系方式???','1102',0),(2,1,'江南铭庭超市','浙江省','杭州市','滨江区','江南铭庭002','联系方式???','120',0);
