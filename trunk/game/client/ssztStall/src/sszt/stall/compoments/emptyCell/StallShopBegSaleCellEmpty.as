package sszt.stall.compoments.emptyCell
{
	...
	public class StallShopBegSaleCellEmpty extends StallCellBaseEmpty
	{
		public function StallShopBegSaleCellEmpty()
		{
			super();
		}
		...
		override public function dragDrop(data:IDragData):int
		{
			...
			if(source.getSourceType() == CellType.STALLSHOPPINGBUYCELL)
			{
