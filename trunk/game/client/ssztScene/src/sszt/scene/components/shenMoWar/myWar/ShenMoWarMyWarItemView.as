package sszt.scene.components.shenMoWar.myWar
{
	...
	public class ShenMoWarMyWarItemView extends Sprite
	{
		private var _mediator:SceneWarMediator;
		private var _info:ShenMoWarMyWarItemInfo;
		...
		public function ShenMoWarMyWarItemView(argMediator:SceneWarMediator,argInfo:ShenMoWarMyWarItemInfo)
		{
			super();
