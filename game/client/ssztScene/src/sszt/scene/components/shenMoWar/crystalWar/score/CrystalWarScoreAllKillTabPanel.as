package sszt.scene.components.shenMoWar.crystalWar.score
{
	...
	public class CrystalWarScoreAllKillTabPanel extends Sprite implements CrystalWarScoreInterface
	{
		...
		public function CrystalWarScoreAllKillTabPanel(argMediator:SceneWarMediator)
		{
			super();
...
//			addChild(label8);
		...
		{
			var tmpList:Array = crystalWarScoreInfo.getSortOnList(0);
			if(!tmpList)return;
