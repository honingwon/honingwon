			...
			if(_GroupList == null)
				...
				if (_GroupList != null && _GroupList.length > 0) {
					for (var i = 0; i < _GroupList.length; i++) {
						if(!isHasInGroup(_GroupList[i].group_id))
							html +="<li><label><input type='checkbox' name='groupcheckname' class='checkbox' id='"+_GroupList[i].group_id+"' />"+_GroupList[i].group_name+"</label></li>";
						else
							html +="<li><label><input type='checkbox' name='groupcheckname' class='checkbox' checked='checked' id='"+_GroupList[i].group_id+"' />"+_GroupList[i].group_name+"</label></li>";
					}
				}
			}
			$("#GroupList").html(html);	
