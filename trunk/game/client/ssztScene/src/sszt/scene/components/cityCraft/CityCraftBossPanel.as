...
//	import ssztui.club.ClubTitleBossAsset;
	...
	public class CityCraftBossPanel extends MPanel implements ITick
	{
		...
		private var _bossIntroView:CityCraftBossIntroView;
		private var _rewardsTile:MTile;
		private var _pagePrevBtn:MCacheAssetBtn1;//MAssetButton1;
		private var _pageNextBtn:MCacheAssetBtn1;//MAssetButton1;
		
		private var _currentBossItemView:CityCraftBossItemView;
		...
		public function CityCraftBossPanel(mediator:SceneMediator)
		{
			_bossArr = ClubCampCallTemplateList.bossArr;
			_mediator = mediator;
		...
		override protected function configUI():void
		{
			...
			_pagePrevBtn = new MCacheAssetBtn1(0,3,LanguageManager.getWord('ssztl.cityCraft.beckon'));
			//new MAssetButton1(new BtnPageAsset() as MovieClip);
			_pagePrevBtn.move(10,76);
			addContent(_pagePrevBtn);
			
			_pageNextBtn =new  MCacheAssetBtn1(0,3,LanguageManager.getWord('ssztl.cityCraft.beckon'));
			//new MAssetButton1(new BtnPageAsset() as MovieClip);
//			_pageNextBtn.scaleX = -1;
			_pageNextBtn.move(384,76);
			addContent(_pageNextBtn);
			  
			_bossIntroView = new CityCraftBossIntroView();
			...
			var bossItemView:CityCraftBossItemView;
			var bossTemplateInfo:ClubBossTemplateInfo;
			for each(bossTemplateInfo in _bossArr)
			{
				bossItemView = new CityCraftBossItemView(bossTemplateInfo,callingBossHandler);
			...
			_tip.move(30,318);
			addContent(_tip);
			_tip.setHtmlValue(LanguageManager.getWord("ssztl.cityCraft.callBossTip"));
		}
		...
		{
			var bossItemView:CityCraftBossItemView = event.currentTarget as CityCraftBossItemView;
			currentBossItemView = bossItemView;
		}
		
		public function set currentBossItemView(bossItemView:CityCraftBossItemView):void
		{
		...
		{
//			clubModule.clubCampInfo.addEventListener(ClubCampInfoUpdateEvent.CALL_CLUB_BOSS_SUCCESSFULLY,callBossSuccessfullyHandler);
			CityCraftBOSSCallSocketHandler.send(bossInfo.bossId);
		}
		...
		public function get bossIntroView():CityCraftBossIntroView
		{
