...
?>
	...
	<head>
		...
		<script type="text/javascript" src="js/arpuSearch.js"></script>
		<style type="text/css">
    ...
    <thead>
    	<tr>
            ...
            <th width="50">充值人数</th>
            <th width="50">充值次数</th>
            <th width="50"><span title="充值人数/登录人数"><img src="../images/tipHelpnew.png"></img>充值比例</span></th>
            <th width="50"><span title="充值金额/充值人数"><img src="../images/tipHelpnew.png"></img>ARPU值</span></th>
        </tr>
    </thead>
    <tbody id="List_Body">
    </tbody>
