package sszt.rank.components.views.individual
{
	...
	public class VeinsRankView extends RankViewImpl
	{
		...
		public function VeinsRankView(rankInfos:RankInfo)
		{
			super();
		...
		private function initView():void
		{
			...
			addChild(MBackgroundLabel.getDisplayObject(new Rectangle(colX[3]+2,3,_colWidth[4],16),new MAssetLabel(LanguageManager.getWord("ssztl.rank.venis"),MAssetLabel.LABEL_TYPE_TITLE2)));
