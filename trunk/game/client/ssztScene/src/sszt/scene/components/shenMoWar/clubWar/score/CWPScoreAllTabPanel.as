package sszt.scene.components.shenMoWar.clubWar.score
{
	...
	public class CWPScoreAllTabPanel extends Sprite implements CWPScoreInterface
	{
		...
		public function CWPScoreAllTabPanel(argMediator:SceneWarMediator)
		{
			super();
		...
		{
			var tmpList:Array = clubPointWarScoreInfo.getSortOnList(1);
			if(!tmpList)return;
