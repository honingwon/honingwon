package sszt.scene.components.shenMoWar.personalWar
{
	...
	public class PerWarMainItemView extends Sprite
	{
		private var _mediator:SceneWarMediator;
		private var _info:PerWarMainItemInfo;
		...
		public function PerWarMainItemView(argMediator:SceneWarMediator,argInfo:PerWarMainItemInfo)
		{
			super();
		...
		private function initialView():void
		{
			...
			var descriptionLabel:MAssetLabel = new MAssetLabel(LanguageManager.getWord("ssztl.scene.huanGu"),MAssetLabel.LABELTYPE1);
		...
		public function get info():PerWarMainItemInfo
		{
			return _info;
		}
		
		public function set info(value:PerWarMainItemInfo):void
		{
			_info = value;
		}
	}
