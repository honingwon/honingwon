package sszt.loader.newResource
{
	...
	public class PicLoaderManager implements ITick 
	{
		...
		public static const LOAD_LINE:int = 2;
		...
		public function getFile(path:String, callback:Function, clearType:int, clearTime:int=214783647, priority:int=1):void
		{
			...
			if (cache == null){
				cache = new PicLoaderList(path, callback, clearType, clearTime, this, priority);
		...
		public function pathComplete(list:PicLoaderList):void
		{
