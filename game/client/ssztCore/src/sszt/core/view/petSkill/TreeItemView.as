package sszt.core.view.petSkill
{
	...
	public class TreeItemView extends Sprite
	{
		...
		public function TreeItemView(obj:Object)
		{
			_info = obj;
			init();
			initEvents();
		...
		private function init():void
		{
			...
			_bg = BackgroundUtils.setBackground([
				new BackgroundInfo(BackgroundType.DISPLAY, new Rectangle(0, 22, 114, 2),new MCacheSplit2Line())
			]);
			addChild(_bg as DisplayObject);
			_bg.alpha = 0.5;
			
			_selectedBorder = MBackgroundLabel.getDisplayObject(new Rectangle(-10,0,134,23),new BarAsset3()) as Sprite;
			_selectedBorder.mouseEnabled = false;
			addChild(_selectedBorder);
			_selectedBorder.visible = false;
			
			_itemField = new TextField();
			_itemField.width = 114;
