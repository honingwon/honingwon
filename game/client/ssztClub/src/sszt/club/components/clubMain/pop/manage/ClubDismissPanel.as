package sszt.club.components.clubMain.pop.manage
{
	...
	import sszt.club.socketHandlers.ClubDismissSocketHandler;
	...
	public class ClubDismissPanel extends MPanel
	{
		...
		public function ClubDismissPanel(mediator:ClubMediator)
		{
			_mediator = mediator;
		...
		private function initView():void
		{
			...
			var label1:MAssetLabel = new MAssetLabel(LanguageManager.getWord("ssztl.club.carefulReleaseClub"),[new TextFormat(LanguageManager.getWord("ssztl.common.wordType"),14,0xFFFFFF),new GlowFilter(0x1D250E,1,4,4,4.5)]);
			label1.move(28,22);
			addContent(label1);
		...
		private function btnClickHandler(e:MouseEvent):void
		{
			...
			switch(e.currentTarget)
			{
				case _okBtn:
					...
					{
						MAlert.show(LanguageManager.getWord("ssztl.club.releaseClubFail"),LanguageManager.getWord("ssztl.common.alertTitle"));
						return;
					}
					ClubDismissSocketHandler.send();
					break;
				case _cancelBtn:
					dispose();
					break;
