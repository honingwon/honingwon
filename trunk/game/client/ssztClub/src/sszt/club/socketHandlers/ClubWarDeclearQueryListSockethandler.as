package sszt.club.socketHandlers
{
	...
	public class ClubWarDeclearQueryListSockethandler extends BaseSocketHandler
	{
		public function ClubWarDeclearQueryListSockethandler(handlerData:Object=null)
		{
			super(handlerData);
		}
		...
		{
			return ProtocolType.CLUB_WAR_DECLEAR_INIT;
		}
		...
		{
			var pkg:IPackageOut = GlobalAPI.socketManager.getPackageOut(ProtocolType.CLUB_WAR_DECLEAR_INIT);
			pkg.writeShort(page);
