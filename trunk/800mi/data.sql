...
insert  into `bm_purchase_info`(`shopping_cart_id`,`purchase_id`,`goods_id`,`goods_num`,`goods_active_etime`,`purchase_goods_price`,`purchase_state`) values (1,1,1,2,0,5,0),(2,1,2,1,0,3,0),(3,2,1,2,0,5,0),(4,2,2,1,0,3,0),(5,3,1,2,0,5,0),(6,3,2,1,0,3,0);
...
insert  into `bm_purchase_list`(`purchase_id`,`account_id`,`shop_id`,`add_time`,`purchase_state`,`return_time`,`purchase_price`,`purchase_remark`) values (1,1,1,1394001391,98,0,0,'123'),(2,1,1,1394002773,0,0,0,'123'),(3,1,1,1394070948,0,0,0,'123');
