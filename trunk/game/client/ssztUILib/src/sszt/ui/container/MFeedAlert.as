package sszt.ui.container
{
	...
	public class MFeedAlert extends MPanel3
	{
...
//		public static var refuseLabel:int = 2;
		...
		public function MFeedAlert(message:String = "",title:String = "",flags:uint = 4,parent:DisplayObjectContainer = null,closeHandler:Function = null,textAlign:String = "center",width:Number = -1,closeAble:Boolean = true,appStyle:Boolean = true)
		{
		...
		public static function show(message:String = "",title:String = "",flags:uint = 4,parent:DisplayObjectContainer = null,closeHandler:Function = null,textAlign:String = "center",width:Number = -1,closeAble:Boolean = true,applyStyle:Boolean = true):void
		{
			...
			{
				priority++;
				var alert:MFeedAlert = new MFeedAlert(message,title,flags,parent,closeHandler,textAlign,width,closeAble,applyStyle);
