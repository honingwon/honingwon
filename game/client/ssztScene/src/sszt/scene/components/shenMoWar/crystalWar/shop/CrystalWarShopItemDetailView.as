package sszt.scene.components.shenMoWar.crystalWar.shop
{
	...
	public class CrystalWarShopItemDetailView extends Sprite
	{
		private var _info:ShopItemInfo;
		private var _cell:CrystalWarShopItemCell;
		...
		public function CrystalWarShopItemDetailView()
		{
			super();
			init();
			initEvent();
		...
		private function init():void
		{
			...
			_cell = new CrystalWarShopItemCell();
			_cell.move(0,20);
			addChild(_cell);
		}
