package sszt.core.socketHandlers.personal.dynamicInfo
{
	...
	public class PersonalClubMateDeadSocketHandler extends BaseSocketHandler
	{
		public function PersonalClubMateDeadSocketHandler(handlerData:Object=null)
		{
			super(handlerData);
		}
		override public function getCode():int
		{
			return ProtocolType.PERSONAL_CLUBMATE_DEAD;
		}
		
		override public function handlePackage():void
		{
			var tmpItemInfo:PersonalDynamicItemInfo = new PersonalDynamicItemInfo();
			tmpItemInfo.typeId = PersonalDynamicType.CLUBMATE_DEAD;
		...
		{
			var pkg:IPackageOut = GlobalAPI.socketManager.getPackageOut(ProtocolType.PERSONAL_CLUBMATE_DEAD);
