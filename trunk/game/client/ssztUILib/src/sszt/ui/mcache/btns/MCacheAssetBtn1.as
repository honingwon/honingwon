...
package sszt.ui.mcache.btns
{
	...
	import ssztui.ui.BtnAsset1;
	import ssztui.ui.BtnAsset2;
	import ssztui.ui.BtnAsset3;
	
	public class MCacheAssetBtn1 extends MAssetButton
	{
		private static const _movies:Array = [new Array(4),new Array(3),new Array(1)];
		
		private static const _scale9Grids:Array = [
			new Rectangle(10,10,25,6),new Rectangle(5,5,19,10),new Rectangle(25,6,50,18)
		];
		private static const _xscales:Array = [[1,1.22,1.4,1.55,2.6],[1,1.37,2.17,2.6],[1]];
		private static const _labelYOffsets:Array = [1,2,3];
		
		private static const _styles:Array = [
			[new TextFormat("SimSun",12,0xFFFFFF),[new GlowFilter(0x12191d,1,2,2,6)]],
			[new TextFormat("SimSun",12,0xFFFFFF),[]], //new GlowFilter(0x000000,1,3,3,8)
			[new TextFormat("SimSun",12,0xFFFFFF,true),[new GlowFilter(0x000000,1,2,2,6)]]
		];
		private static const _classes:Array = [BtnAsset1,BtnAsset2,BtnAsset3];
		private static const _sizes:Array = [new Point(45,26),new Point(29,20),new Point(100,30)];
		 ...
		 * 
		 */		
		public function MCacheAssetBtn1(type:int,xscaleType:int,label:String = "")
		{
			_type = type;
