package sszt.club.socketHandlers
{
	...
	public class ClubWarDealQueryListSockethandler extends BaseSocketHandler
	{
		public function ClubWarDealQueryListSockethandler(handlerData:Object=null)
		{
			super(handlerData);
		}
		...
		{
			return ProtocolType.CLUB_WAR_DEAL_INIT;
		}
...
//				tmpItemInfo.warState = _data.readInt();
		...
		{
			var pkg:IPackageOut = GlobalAPI.socketManager.getPackageOut(ProtocolType.CLUB_WAR_DEAL_INIT);
			pkg.writeShort(page);
