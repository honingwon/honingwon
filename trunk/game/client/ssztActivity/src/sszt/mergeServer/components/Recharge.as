package sszt.mergeServer.components
{
	...
	import sszt.mergeServer.components.item.RecItemView;
	...
	public class Recharge extends Sprite implements IPanel
	{
		...
		private var _type:int = 84; //1:首充2:开服充值,3:开服消费4.单笔充值5.VIP6.紫装7.一定时间内升级
		private var _typeArray:Array = [84,85,86];
		/**
		 * 模板数据 
		 */
		...
		public function initView():void
		{
			...
			addChild(_txtTitle);
			_txtTitle.setHtmlValue(LanguageManager.getWord("ssztl.mergeServer.acName5"));
			...
			addChild(_txtDetail);
			_txtDetail.setHtmlValue(LanguageManager.getWord("ssztl.mergeServer.acDetail5"));
