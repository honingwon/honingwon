...
package
{
	...
	[SWF(backgroundColor=0x293739,frameRate=25)]
	public class ssztGameLoader2 extends Sprite
	{
		public var backgroundColor:uint = 0x293739;
		private var _nameInput:TextField;
		private var _portInput:TextField;
		public function ssztGameLoader2()
		{
			super();
			new Declear2();
		...
		private function ssztPrepare(e:Event):void
		{
			...
			var sign:String = MD5.hash(user + site + tick + "qq-zone-710-5000-cm3d");// "qq-zone-710-5000-cm3d");  qq-zone-7101545-911-cm  s0.app100722626.twsapp.com
			paras = {
				user:user,site:"sszt",tick:tick,sign:sign ,fcm : 1,pf:"" ,pfKey:"",openKey:"" ,zoneId:0,domain:"119.147.19.43",ip : "192.168.3.5",port :8010,guest : "0",isYellowVip:0,isYellowYearVip:0,yellowVipLevel:0,isYellowHighVip:0
			}
