...
package sszt.loader.fanm
{
	...
	public class FanmLoaderManager implements ITick 
	{
		...
		public function FanmLoaderManager()
		{
		...
		public function getFile(path:String, callback:Function, clearType:int, clearTime:int=214783647, priority:int=1,hadcryptType:int=0):void
		{
			var cache:FanmLoaderList = this.caches[path];
			if (cache == null)
			{
				cache = new FanmLoaderList(path, callback, clearType, clearTime, this, priority,hadcryptType);
		...
		public function setCacheClearList(cache:FanmLoaderList):void
		{
			var index:int;
		...
		public function update(times:int, dt:Number=0.04):void
		{
			var n:int;
			var i:int;
			var cache:FanmLoaderList;
			var loaded:FanmLoaderList;
			var list:Array;
		...
		public function pathComplete(list:FanmLoaderList):void
		{
