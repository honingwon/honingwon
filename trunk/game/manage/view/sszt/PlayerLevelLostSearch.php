...
?>
	...
	<head>
		...
		<script type="text/javascript" src="js/PlayerLevelLostSearch.js"></script>
		<style type="text/css">
    ...
    <form class="inBody">
   	 <table>
   	 	<tr>
        	<td width="90">类型：</td><td>
            <input type="radio" name="type" checked='checked' value = "1" />所有玩家&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="type" value = "2" />流失玩家&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
        </tr> 	
        <tr>
