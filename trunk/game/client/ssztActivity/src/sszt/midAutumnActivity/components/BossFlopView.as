package sszt.midAutumnActivity.components
{
	...
	import sszt.midAutumnActivity.components.item.Cell;
	...
	public class BossFlopView extends Sprite
	{
		...
		private var _bossId:Array = [300000,203017,203020,201001,201002,201027,201028,203012,204003,250001,201032,206004];
		private var _mononsterId:Array = [300000,203016,203019,201001,201027,203011,206003,201031];
		...
		{
			SetModuleUtils.addExStore(new ToStoreData(ShopID.MOONCAKE,4)); 
			//			if(!_exchangePanel)
			//			{
