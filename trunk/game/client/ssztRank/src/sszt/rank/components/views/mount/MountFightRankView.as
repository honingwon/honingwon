package sszt.rank.components.views.mount
{
	...
	public class MountFightRankView extends RankViewImpl
	{
		...
		private var _curItemView:MountFightRankItemView;
		
		private var _colWidth:Array = [51,130,174,110];
		
		public function MountFightRankView(rankInfos:RankInfo)
		{
		...
		private function initView():void
		{
			...
			addChild(MBackgroundLabel.getDisplayObject(new Rectangle(colX[2]+2,3,_colWidth[3],16),new MAssetLabel(LanguageManager.getWord("ssztl.common.mountFight"),MAssetLabel.LABEL_TYPE_TITLE2)));
