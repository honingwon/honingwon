package sszt.scene.actions
{
	...
	public class SetHangupSelectAction1 extends BaseCharacterAction
	{
		...
		public function SetHangupSelectAction1(character:BaseRole,mediator:SceneMediator)
		{
			_mediator = mediator;
			super(null,0);
				...
				if(MapTemplateList.isGuardDuplicate())//守护副本挂机
				{
					...
					if(!monster2)
					{
						...
						if(monster2 && _sceneInfo.hangupData.attackPath.length > 0)
						{
							...
							{
								if(monster2.getDistance(_sceneInfo.hangupData.attackPath[_sceneInfo.hangupData.attackIndex - 1]) > 400)
									monster2 = null;
							}
						}
					}
