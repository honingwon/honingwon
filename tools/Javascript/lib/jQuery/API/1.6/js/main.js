$(function(){
	...
	if( ($.browser.msie && $.browser.version == 6 ))
		$('#ifIe6').html('<div style="background-color:#FFF2F2;border:1px solid #FF8080;font-size:14px; padding:60px; line-height:180%;"><strong style="color:#FF3300">不是吧？身为一个前端，你居然用IE6 ！！！<br />请使用 Firefox/Chrome/Safari/Opera等浏览器查看！！！否则只提供部分功能。<br />如果您不知道什么是IE6 ，那么请关闭本页，此页内容不适合您.</div>');
...
jqapi = function() {
  ...
  var values = {
    ...
    sub:            'sub',
    hasFocus:       true,
    loader:         '<div class="loading"><div id="loader"></div></div>',
    title:          'jQuery 1.6 API 中文版 - '
  };
  ...
  function initialize() {
    ...
    elements.window.resize(function() {
      ...
      var listH = winH - values.searchHeight - $('#logo').height();
...
/*  var navigation_el = $('#navigation').load('navigation.php', function() { //load the navigation (not static because it gets generated with the api scraping)  
    jqapi.initialize();
  });*/
   var navigation_el;
    jqapi.initialize();
