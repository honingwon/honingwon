package sszt.rank.components.views.individual
{
	...
	public class AchieveRankView extends RankViewImpl
	{
		...
		public function AchieveRankView(rankInfos:RankInfo)
		{
		...
		private function initView():void
		{
			...
			addChild(MBackgroundLabel.getDisplayObject(new Rectangle(colX[3]+2,3,_colWidth[4],16),new MAssetLabel(LanguageManager.getWord("ssztl.common.achieve"),MAssetLabel.LABEL_TYPE_TITLE2)));
