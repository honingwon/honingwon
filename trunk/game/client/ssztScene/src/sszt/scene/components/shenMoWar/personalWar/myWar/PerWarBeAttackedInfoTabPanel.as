package sszt.scene.components.shenMoWar.personalWar.myWar
{
	...
	public class PerWarBeAttackedInfoTabPanel extends Sprite implements IPerWarMyWarInfoInterface
	{
		...
		public function PerWarBeAttackedInfoTabPanel(argMediator:SceneWarMediator)
		{
			super();
		...
		{
			clearList();
			for each(var i:PerWarMyWarItemInfo in myWarInfo.beAttackedInfoList)
			{
