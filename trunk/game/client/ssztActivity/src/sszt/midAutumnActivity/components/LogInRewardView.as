package sszt.midAutumnActivity.components
{
	...
	public class LogInRewardView extends Sprite
	{
		...
		public function initView():void
		{
			_bg = BackgroundUtils.setBackground([
				...
				new BackgroundInfo(BackgroundType.DISPLAY, new Rectangle(0,188,422,15),new MAssetLabel(LanguageManager.getWord("ssztl.midAutumnActivity.openGiftGet"),MAssetLabel.LABEL_TYPE_TAG)),
			...
			addChild(_txtTitle);
			_txtTitle.setHtmlValue(LanguageManager.getWord("ssztl.midAutumnActivity.acName1"));
			...
			addChild(_txtDetail);
			_txtDetail.setHtmlValue(LanguageManager.getWord("ssztl.midAutumnActivity.acDetail1"));
		...
		{
			var bigItem:ItemTemplateInfo = ItemTemplateList.getTemplate(297001);
