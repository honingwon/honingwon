...
<script type="text/javascript" src="<?php echo JS_DIR;?>/BaseData/CardItemUpdate.js"></script>
...
<div class="mdForm">
    ...
    <table>
    	...
    	<tr><td><input type="radio" name="type" id="sendname" checked="checked" />&nbsp;道具名称：<input type="text" class="input" size="20" id="txtSearchName" /> </td></tr>
    	<tr><td><input type="radio" name="type" id="sendID"  />&nbsp;道 具 ID ：<input type="text" class="input" size="20" id="txtSearchID" /> </td></tr>
        <tr><td><button type="button" id="btnSearch" >查找</button>  <button type="button" id="btnAddGameItem" style="display:none;">添加新道具</button> </td></tr>
    </table>
    </form>
</div>
<table class="tabData">
