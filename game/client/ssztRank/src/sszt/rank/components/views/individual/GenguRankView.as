package sszt.rank.components.views.individual
{
	...
	public class GenguRankView extends RankViewImpl
	{
		...
		public function GenguRankView(rankInfos:RankInfo)
		{
			super();
		...
		private function initView():void
		{
			...
			addChild(MBackgroundLabel.getDisplayObject(new Rectangle(colX[3]+2,3,_colWidth[4],16),new MAssetLabel(LanguageManager.getWord("ssztl.common.boneLabel"),MAssetLabel.LABEL_TYPE_TITLE2)));
