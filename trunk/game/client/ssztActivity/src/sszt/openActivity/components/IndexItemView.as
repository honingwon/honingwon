package sszt.openActivity.components
{
	...
	import ssztui.openServer.ListItemAsset;
	import ssztui.openServer.ListItemOverAsset;
	import ssztui.openServer.ListItemiconAsset3;
	import ssztui.openServer.ListItemiconAsset4;
	import ssztui.openServer.ListItemiconAsset5;
	import ssztui.openServer.ListItemiconAsset6;
	import ssztui.openServer.ListItemiconAsset7;
	...
	public class IndexItemView extends Sprite
	{
		...
		private var _btnNameArray:Array = [
			LanguageManager.getWord("ssztl.activity.listLabel1"),
			LanguageManager.getWord("ssztl.activity.listLabel2"),
			LanguageManager.getWord("ssztl.activity.listLabel3"),
//			LanguageManager.getWord("ssztl.activity.listLabel8"),
			LanguageManager.getWord("ssztl.activity.listLabel4"),
			LanguageManager.getWord("ssztl.activity.listLabel5"),
			LanguageManager.getWord("ssztl.activity.listLabel6"),
			LanguageManager.getWord("ssztl.activity.listLabel7")
		];
		private var _iconArray:Array = [
			ListItemiconAsset3,ListItemiconAsset3,ListItemiconAsset7,
			ListItemiconAsset24,
			ListItemiconAsset4,
			ListItemiconAsset5,
			ListItemiconAsset6
