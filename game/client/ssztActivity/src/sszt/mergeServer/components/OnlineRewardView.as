package sszt.mergeServer.components
{
	...
	import sszt.mergeServer.components.item.BigCell;
	...
	public class OnlineRewardView extends Sprite
	{
		...
		public function initView():void
		{
			_bg = BackgroundUtils.setBackground([
				...
				new BackgroundInfo(BackgroundType.DISPLAY, new Rectangle(19,64,60,15),new MAssetLabel(LanguageManager.getWord("ssztl.mergeServer.rewardLevel")+"：",MAssetLabel.LABEL_TYPE20,"left")),
				...
				new BackgroundInfo(BackgroundType.DISPLAY, new Rectangle(0,188,422,15),new MAssetLabel(LanguageManager.getWord("ssztl.mergeServer.openGiftGet"),MAssetLabel.LABEL_TYPE_TAG)),
			...
			addChild(_txtTitle);
			_txtTitle.setHtmlValue(LanguageManager.getWord("ssztl.mergeServer.acName1"));
			
			_txtTime = new MAssetLabel(LanguageManager.getWord("ssztl.mergeServer.endTime"),MAssetLabel.LABEL_TYPE20,TextFormatAlign.LEFT);
			_txtTime.move(79,42);
			addChild(_txtTime);
			...
			addChild(_txtDetail);
			_txtDetail.setHtmlValue(LanguageManager.getWord("ssztl.mergeServer.acDetail1"));
			...
			_getReward.move(144,287);
			addChild(_getReward);
			
			_getGo = new MCacheAssetBtn1(0,3,LanguageManager.getWord("ssztl.common.transferRightNow"));
			_getGo.move(217,287);
			addChild(_getGo);
		...
		public function initEvent():void
		{
			...
			_getGo.addEventListener(MouseEvent.CLICK,flyClickHandler);
		}
		public function removeEvent():void
		{
			_getReward.removeEventListener(MouseEvent.CLICK,btnClickHandler);
			_getGo.removeEventListener(MouseEvent.CLICK,flyClickHandler);
		}
		
		private function btnClickHandler(e:MouseEvent):void
		{
			ModuleEventDispatcher.dispatchSceneEvent(new SceneModuleEvent(SceneModuleEvent.WALKTONPC,102107));
		}
		private function flyClickHandler(e:MouseEvent):void
		{
			...
			{
				var npc:NpcTemplateInfo = NpcTemplateList.getNpc(102107);
		...
		{
			var bigItem:ItemTemplateInfo = ItemTemplateList.getTemplate(297100);
