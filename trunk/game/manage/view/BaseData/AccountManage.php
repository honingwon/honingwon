...
<div class="fwinly" style="left:50%; margin-left:-250px; top:113px;" id="perAccount">
	<table class="fwin">
    	<tr><td class="t_l"></td><td class="t_c"></td><td class="t_r"></td></tr>
        <tr><td class="m_l"></td><td class="m_c">
            <h3 class="ftitle"><strong id="moduleTitle" >设置个人权限</strong><a href="#" class="fclose" id="BtnclosePerAccount">关闭</a></h3>
            <div class="perly" style="width:350px;">
            	<div class="noneBox fixed" style="height:320px;">
            ...
            <div class="formly" style="width:500px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <option value="2" selected="selected">普通员工</option></select></td>
                        <td>电话：</td><td><input type="text" class="input" size="20" id="Phone" onblur="checkPhone();" /></td>
                    </tr>
                    <tr>
                        <td>MSN/QQ：</td><td><input type="text" class="input" size="20" id="QQ" onblur="checkQQ();"  /></td>
                        <td>*邮箱：</td><td><input type="text" class="input" size="20" id="Email" onblur="checkEmail();"   /></td>
                    </tr>
                    <tr>
                        <td>联系地址：</td><td colspan="3"><input type="text" class="input" size="50" id="Address" onblur="checkAdress();" /></td>
                    </tr>
                    <tr>
