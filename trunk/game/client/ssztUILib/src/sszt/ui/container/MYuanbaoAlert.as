package sszt.ui.container
{
	...
	public class MYuanbaoAlert extends MPanel3
	{
...
//		public static var refuseLabel:int = 2;
		...
		public static var _chbflag:Boolean = false;
		private static var priority:int = 1;
		private static var _closeHandler:Function;
		
		public function MYuanbaoAlert(message:String = "",title:String = "",flags:uint = 4,parent:DisplayObjectContainer = null,closeHandler:Function = null,textAlign:String = "center",width:Number = -1,closeAble:Boolean = true,appStyle:Boolean = true)
		{
		...
		public static function show(message:String = "",title:String = "",flags:uint = 4,parent:DisplayObjectContainer = null,closeHandler:Function = null,textAlign:String = "center",width:Number = -1,closeAble:Boolean = true,applyStyle:Boolean = true):void
		{
			if(_chbflag)
			{
				_closeHandler = closeHandler;
			...
			{
				priority++;
				var alert:MYuanbaoAlert = new MYuanbaoAlert(message,title,flags,parent,closeHandler,textAlign,width,closeAble,applyStyle);
