package sszt.scene.components.shenMoWar.crystalWar.score
{
	...
	public class CrystalWarScoreCampTabPanel extends Sprite implements CrystalWarScoreInterface
	{
		...
		public function CrystalWarScoreCampTabPanel(argMediator:SceneWarMediator)
		{
			super();
		...
		{
			var tmpList:Array = crystalWarScoreInfo.getSortOnList(1,GlobalData.selfPlayer.serverId.toString());
			if(!tmpList)return;
