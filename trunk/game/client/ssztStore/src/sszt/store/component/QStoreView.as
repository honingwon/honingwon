package sszt.store.component
{
	...
	public class QStoreView extends MSprite 
	{
		...
		public function QStoreView(mediator:StoreMediator,data:ToStoreData)
		{
		...
		protected function init():void
		{
			...
			addChild(_titleTip);
			_titleTip.setHtmlValue(LanguageManager.getWord("ssztl.common.goldMarketTip"));
...
//			_btns = new Vector.<MCacheTab1Btn>();
			...
			var shopCategoryNames:Array = ['新品热销']
...
//				addChild(btn);
		...
		private function setTabPanel(index:int):void
		{
			...
			if(tmpIndex < 3)
			{
				...
				_pageView.totalRecord = shop.shopItemInfos[6].length;
