...
<!--部分JS仅显示方便使用，您真的可以忽视-->
<div class="mdIntro" style="margin-top:10px;">
	<span class="iconIntro"></span>
	<dl>
		<dt>提示说明：</dt>
        <dd>1、根据所指定的卡种类进行道具分配并填写数量。</dd>
    </dl>
</div>
<table class="wrapCol3">
    ...
    <td class="it" width="28%">
        <table class="tabSelect" onmouseover="Change(this,1);">
            <thead><tr><th>当前道具卡种类 <input type="text" class="input" size="12" id="txtTypeName"  /><button type="button" id="btnSearchCard" >筛选</button></th></tr></thead>
            <tbody id="List_Body" >    	    	
                <tr><td>光音VIP卡</td></tr>
