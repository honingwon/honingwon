...
package fl.controls {
	...
	public class ComboBox extends UIComponent implements IFocusManagerComponent {
		...
		public function close():void {
			...
			if(list.parent)list.parent.removeChild(list);
		}
...
//			}
		...
		protected function drawTextFormat():void {
			...
			var defaultTF:TextFormat = _enabled ? uiStyles.defaultTextFormat as TextFormat : uiStyles.defaultDisabledTextFormat as TextFormat;
			inputField.textField.defaultTextFormat = defaultTF;
		...
		protected function drawTextField():void {
			...
			var buttonWidth:Number = getStyleValue("buttonWidth") as Number;
			var textPadding:Number = getStyleValue("textPadding") as Number;			
			inputField.setSize(200,200);
			inputField.textField.width = width - 2 * textPadding - buttonWidth;
			inputField.textField.height = height - 2  * textPadding;
		...
		public function setEditableValue(value:String):void
		{
			editableValue = value;
		}
