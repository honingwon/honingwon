package sszt.common.vip.component.sec
{
	...
	public class VipCard2 extends MSprite
	{
		...
		private function initView():void
		{
			...
			_txtTag.setLabelType([new TextFormat("Microsoft Yahei Font",14,0x00ccff,true)]);
			_txtTag.move(164,8);
			addChild(_txtTag); 
			_txtTag.setValue(LanguageManager.getWord("ssztl.basic.hightVipPlayer"));
			...
			_txtTag1.move(14,38);
			addChild(_txtTag1);
			_txtTag1.setHtmlValue(LanguageManager.getWord('ssztl.vip.monthTitle'));
		}
