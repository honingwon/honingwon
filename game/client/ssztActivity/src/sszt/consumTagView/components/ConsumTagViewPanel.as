package sszt.consumTagView.components
{
	 ...
	 * 
	 */	
	public class ConsumTagViewPanel extends MPanel implements ITick
	{
		
		private var _mediator:ConsumTagViewMediator;
...
//		private var _btnPay:MAssetButton1;
		...
		public function ConsumTagViewPanel(mediator:ConsumTagViewMediator)
		{
			super(new MCacheTitle1("",new Bitmap(new ConsumeTitleAsset())),true,-1,true,true);
			_mediator = mediator;
			initEvent();
		}
		...
		override protected function configUI():void
		{
			...
			_bg2 = BackgroundUtils.setBackground([
				new BackgroundInfo(BackgroundType.DISPLAY,new Rectangle(214,15,169,38),new Bitmap(new TitleAsset3())),
...
//					timeStr = OpenActivityUtils.getEndTime(Number(obj.openTime));
			...
			_actCont.setHtmlValue(
				...
				LanguageManager.getWord("ssztl.scene.activityDescription")+"：" + LanguageManager.getWord("ssztl.openActivityactCont.actCont2")
			)
			_myPayTxt.setHtmlValue(
				LanguageManager.getWord("ssztl.activity.TagCurrentConsum") + 
				"<font size='14' color='#ff9900'>" + obj.totalValue + LanguageManager.getWord("ssztl.common.yuanBao") + "</font>"
			);
