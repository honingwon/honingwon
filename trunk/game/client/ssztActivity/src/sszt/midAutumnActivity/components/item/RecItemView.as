package sszt.midAutumnActivity.components.item
{
	...
	public class RecItemView extends Sprite implements IPanel
	{
		/**
		 * 已领取 
		 */
		...
		public function RecItemView(opActObj:OpenActivityTemplateListInfo)
		{
			super();
			_opActObj = opActObj;
			initView();
