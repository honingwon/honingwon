package sszt.scene.components.shenMoWar.shop
{
	...
	public class ShenMoWarShopItemDetailView extends Sprite
	{
		private var _info:ShopItemInfo;
		private var _cell:ShenMoWarShopItemCell;
		...
		public function ShenMoWarShopItemDetailView()
		{
			super();
			init();
			initEvent();
		...
		{
			var label:MAssetLabel = new MAssetLabel(LanguageManager.getWord("ssztl.common.count") + "：",MAssetLabel.LABELTYPE4);
			label.move(9,71);
			addChild(label);
			...
			_cell = new ShenMoWarShopItemCell();
			_cell.move(0,20);
			addChild(_cell);
		}
