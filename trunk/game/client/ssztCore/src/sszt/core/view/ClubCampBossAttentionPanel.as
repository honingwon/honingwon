package sszt.core.view
{
	...
	public class ClubCampBossAttentionPanel extends MSprite implements IPanel
	{
		private var _bg:IMovieWrapper;
		private var _dragArea:MSprite;
		private var _btnClose:MAssetButton1;
		private static var instance:ClubCampBossAttentionPanel;
		...
		public function ClubCampBossAttentionPanel()
		{
			init();
			initEvent();
		}
		...
		protected function init():void
		{
			...
			_picPath = GlobalAPI.pathManager.getActivityBannerPath(3);
		...
		public static function getInstance():ClubCampBossAttentionPanel
		{
			if(instance == null)
			{
				instance = new ClubCampBossAttentionPanel();
			}
			return instance;
		}
