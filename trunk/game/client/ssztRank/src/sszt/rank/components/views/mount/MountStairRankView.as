package sszt.rank.components.views.mount
{
	...
	public class MountStairRankView extends RankViewImpl
	{
		...
		private var _curItemView:MountStairRankView;
		
		private var _colWidth:Array = [51,130,174,110];
		
		public function MountStairRankView(rankInfos:RankInfo)
		{
		...
		private function initView():void
		{
			...
			addChild(MBackgroundLabel.getDisplayObject(new Rectangle(colX[2]+2,3,_colWidth[3],16),new MAssetLabel(LanguageManager.getWord("ssztl.common.mountStair"),MAssetLabel.LABEL_TYPE_TITLE2)));
