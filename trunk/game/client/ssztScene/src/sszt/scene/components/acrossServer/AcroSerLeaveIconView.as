package sszt.scene.components.acrossServer
{
	...
	public class AcroSerLeaveIconView extends Sprite
	{
		private var _mediator:SceneMediator;
		private var _shenMoIcon:Bitmap;
		public function AcroSerLeaveIconView(argMediator:SceneMediator)
		{
			super();
		...
		private function iconClickHandler(e:MouseEvent):void
		{
			...
			MAlert.show(LanguageManager.getWord("ssztl.scene.sureLeaveCrossServerMap"),LanguageManager.getWord("ssztl.common.alertTitle"),MAlert.OK | MAlert.CANCEL,null,closeHandler);
			function closeHandler(e:CloseEvent):void
			{
				if(e.detail == MAlert.OK)
				{
					...
					AcroSerBossLeaveSocketHandler.send();
				}
			}
		}
