package sszt.furnace.data.itemInfo
{
	...
	public class FurnaceItemInfo extends EventDispatcher
	{
		private var _bagItemInfo:ItemInfo;
		public var count:int;
		public var type:int;
//		public var placeList:Vector.<int> = new Vector.<int>();
		public var placeList:Array = [];
		public function FurnaceItemInfo(argBagItemInfo:ItemInfo,argType:int = -1)
		{
...
//				count = _bagItemInfo.count;
//			}
			dispatchEvent(new FuranceEvent(FuranceEvent.ITEMINFO_CELL_UPDATE));
		}
