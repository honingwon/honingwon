package sszt.rank.components.itemView.individual
{
	...
	public class IndividualRankItemView extends RankItemView
	{
		...
		private var _rankItemInfo:IndividualRankItem;
		private var _topThree:Bitmap;
		
		private var _colWidth:Array = [51,130,60,114,110];
		
		public function IndividualRankItemView(info:IndividualRankItem)
		{
			super();
			_rankItemInfo = info;
			initView();
		...
		private function initView():void
		{
			...
			//			_roleField.textColor = _rankItemInfo.sex == 0 ? 0xe26cac:0x7bddcc;
			...
			//			var r1:Rectangle = _roleField.getCharBoundaries(0);
			//			var r2:Rectangle = _roleField.getCharBoundaries(_roleField.text.length-1);
			
			_roleSprite = new Sprite();
			_roleSprite.graphics.beginFill(0,0);
			//			_roleSprite.graphics.drawRect(r1.x,r1.y,(r2.x-r1.x)+r2.width,18);
