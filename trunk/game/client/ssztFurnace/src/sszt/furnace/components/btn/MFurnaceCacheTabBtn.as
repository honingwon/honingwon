...
{	
		...
		public class MFurnaceCacheTabBtn extends MTabButton
		{
			...
			private static const _styles:Array = [
				[new TextFormat("宋体",12,0x777467),new TextFormat("宋体",12,0xFFFFFF),[new GlowFilter(0x000000,1,2,2,4)],[new GlowFilter(0x000000,1,2,2,4)]],
				[new TextFormat("宋体",12,0x777467),new TextFormat("宋体",12,0xFFFFFF),[new GlowFilter(0x000000,1,2,2,4)],[new GlowFilter(0x000000,1,2,2,4)]]
			];
			...
			public function MFurnaceCacheTabBtn(type:int,xscaleType:int,label:String = "")
			{
				_type = type;
