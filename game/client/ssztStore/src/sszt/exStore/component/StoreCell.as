package sszt.exStore.component
{
	...
	public class StoreCell extends BaseCell
	{
		...
		private var _tagAmount:MAssetLabel;
		...
		private function buyMAlertHandler(evt:CloseEvent):void
		{
			if(evt.detail == MAlert.OK)
			{
				switch(_shopType)
				{
					...
					case 7:
					case 5:
						ItemBuyExchangeHandler.sendBuy(shopItem.id,_count); //神木203019蚕丝203016
						break;
					case 6:
					case 8:
						ItemBuyByExploitHandler.sendBuy(shopItem.id,_count); // 功勋兑换
						break;
				}
			}
		}
		...
		{
			_tagAmount = new MAssetLabel(LanguageManager.getWord("ssztl.role.exchangeAmount"),MAssetLabel.LABEL_TYPE_TAG,TextFormatAlign.LEFT);
			_tagAmount.move(6,63);
			addChild(_tagAmount);
			...
			_newPriceValue.move(65,30);
			addChild(_newPriceValue);
					
			_buyBtn = new MCacheAssetBtn1(0,1,LanguageManager.getWord("ssztl.scene.exchange"));
			_buyBtn.move(120,57);
			addChild(_buyBtn);
		...
		public function set shopItem(item:ShopItemInfo):void
		{
			...
			if(_shopItem)
			{
				...
				{
					case 4:
						_newPriceValue.setValue(LanguageManager.getWord("ssztl.role.exchangeLable1") + "×" + String(_shopItem.price));
						break;
					case 5:
						_newPriceValue.setValue(LanguageManager.getWord("ssztl.role.exchangeLable2") + "×" + String(_shopItem.price));
						break;
					case 7:
						_newPriceValue.setValue(LanguageManager.getWord("ssztl.common.moonCake") + "×" + String(_shopItem.price));
						break;
					case 6:
					case 8:
						_newPriceValue.setValue(String(_shopItem.price) + LanguageManager.getWord("ssztl.role.exchangeLable3"));
						break;
				}
		...
		public function addGoldIcon():void
		{
			...
			{
				case 1:
//					_goldBg2 = new Bitmap(ExStorePanel.yuanBaoAsset);
					break;
				case 2:
//					_goldBg2 = new Bitmap(ExStorePanel.bindYuanBaoAsset);
					break;
				case 3:
//					_goldBg2 = new Bitmap(ExStorePanel.copperAsset);
					break;
				case 4:
//					_goldBg2 = new Bitmap(ExStorePanel.bindCopperAsset);
					break;
				case 9:
//					_goldBg2 = new Bitmap(ExStorePanel.starAsset);
					break;
				default:
//					_goldBg2 = new Bitmap();
					break;
