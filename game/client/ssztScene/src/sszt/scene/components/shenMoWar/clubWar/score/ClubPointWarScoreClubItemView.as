package sszt.scene.components.shenMoWar.clubWar.score
{
	...
	public class ClubPointWarScoreClubItemView extends Sprite
	{
		...
		public function ClubPointWarScoreClubItemView()
		{
			super();
			initialView();
		}
		...
		private function updateLabel():void
		{
			if(_info)
			{
				...
				_contributeLabel.text = _info.clubContribute.toString();
			}
			else
			{
				_rankLabel.text = "";
