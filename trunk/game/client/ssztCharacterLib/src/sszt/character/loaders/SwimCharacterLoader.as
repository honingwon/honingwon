package sszt.character.loaders
{
	...
	public class SwimCharacterLoader extends LayerCharacterLoader 
	{
		
		public function SwimCharacterLoader(info:ICharacterInfo)
		{
			super(info);
		}
		...
		{
			list.push(CharacterManager.pathManager.getSceneSwimPath(_info.getSex()));
