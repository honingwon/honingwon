package sszt.scene.components.shenMoWar.myWar
{
	...
	public class ShenMoBeAttackedInfoTabPanel extends Sprite implements IShenMoMyWarInfoInterface
	{
		...
		public function ShenMoBeAttackedInfoTabPanel(argMediator:SceneWarMediator)
		{
			super();
		...
		{
			clearList();
			for each(var i:ShenMoWarMyWarItemInfo in myWarInfo.beAttackedInfoList)
			{
