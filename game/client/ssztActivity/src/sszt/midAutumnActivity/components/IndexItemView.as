package sszt.midAutumnActivity.components
{
	...
	import ssztui.openServer.ListItemiconAsset8;
	...
	public class IndexItemView extends Sprite
	{
		...
		private var _btnNameArray:Array = [
			LanguageManager.getWord("ssztl.midAutumnActivity.listLabel1"),
//			LanguageManager.getWord("ssztl.midAutumnActivity.listLabel6"),
			LanguageManager.getWord("ssztl.midAutumnActivity.listLabel2"),
			LanguageManager.getWord("ssztl.midAutumnActivity.listLabel3"),
//			LanguageManager.getWord("ssztl.midAutumnActivity.listLabel4"),
			LanguageManager.getWord("ssztl.midAutumnActivity.listLabel5")
		];
