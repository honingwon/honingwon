...
//	import ssztui.club.CampItemOverAsset;
	...
	public class CityCraftBossItemView extends MSprite
	{
		...
		public function CityCraftBossItemView(bossInfo:ClubBossTemplateInfo,callingBossHandler:Function)
		{
			_bossInfo = bossInfo;
...
//				new BackgroundInfo(BackgroundType.DISPLAY,new Rectangle(1,0,97,138),new Bitmap(new BitmapData())),
//			]);
//			addChild(_bg as DisplayObject);
			...
			_callBtn = new MCacheAssetBtn1(0,3,LanguageManager.getWord('ssztl.cityCraft.beckon'));
