package sszt.club.components.clubMain.pop.items
{
	...
	public class ClubCollectionItemView extends MSprite
	{
		private var _bg:IMovieWrapper;
		private var _overBorder:Bitmap;
		
		private var _collectionInfo:ClubCollectionTemplateInfo;
		...
		public function ClubCollectionItemView(collectionInfo:ClubCollectionTemplateInfo,callingCollectionHandler:Function)
		{
		...
		override protected function configUI():void
		{
			...
			_nameLable = new MAssetLabel("",MAssetLabel.LABEL_TYPE7);
			_nameLable.move(47,87);
			addChild(_nameLable);
			_nameLable.setHtmlValue(_collectionInfo.name);
			
			_callBtn = new MCacheAssetBtn1(0,3,LanguageManager.getWord('ssztl.common.open'));
		...
		{
			_callingCollectionHandler(_collectionInfo);
		}
		
		public function get collectionInfo():ClubCollectionTemplateInfo
		{
