package sszt.rank.components.views.mount
{
	...
	public class MountGrowRankView extends RankViewImpl
	{
		...
		public function MountGrowRankView(rankInfos:RankInfo)
		{
		...
		private function initView():void
		{
			...
			addChild(MBackgroundLabel.getDisplayObject(new Rectangle(colX[2]+2,3,_colWidth[3],16),new MAssetLabel(LanguageManager.getWord("ssztl.common.mountGrow"),MAssetLabel.LABEL_TYPE_TITLE2)));
