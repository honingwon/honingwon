package sszt.scene.components.shenMoWar.personalWar
{
	...
	import sszt.scene.components.shenMoWar.personalWar.members.PerWarMemberTabPanel;
	...
	public class PerWarRewardsPanel extends MPanel
	{
		...
		public function PerWarRewardsPanel(argMediator:SceneWarMediator)
		{
		...
		override protected function configUI():void
		{
			...
			var nameList:Array = [LanguageManager.getWord("ssztl.scene.huanGu")];
//			var nameList:Array = [LanguageManager.getWord("ssztl.scene.shenMoWar")];
			_btns = [];
			_classes = [PerWarMemberTabPanel];
			_panels = [];
...
//			label2.move(500,402);
//			addContent(label2);
//			//			label2.htmlText = "<font color = '#FFFDA5'>注意：</font>离开战场后7分钟内不能进入。";
