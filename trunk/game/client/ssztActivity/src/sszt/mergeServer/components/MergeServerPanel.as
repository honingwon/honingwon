package sszt.mergeServer.components
{
	...
	import sszt.mergeServer.components.IndexItemView;
	...
	public class MergeServerPanel extends MSprite implements IPanel
	{
		...
		public function MergeServerPanel()
		{
			init();
			initEvent();
		}
		protected function init():void
		{
			...
			_classes = [OnlineRewardView,StoreView,Recharge]; //2: ExchangeView, 3: BossFlopView
		...
		public function assetsCompleteHandler():void
		{
			...
			_bgTitle.bitmapData = AssetUtil.getAsset("ssztui.midAutmn.TitleAsset",BitmapData) as BitmapData;
