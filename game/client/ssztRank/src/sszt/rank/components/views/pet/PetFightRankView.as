package sszt.rank.components.views.pet
{
	...
	public class PetFightRankView extends RankViewImpl
	{
		...
		public function PetFightRankView(rankInfos:RankInfo)
		{
		...
		private function initView():void
		{
			...
			addChild(MBackgroundLabel.getDisplayObject(new Rectangle(colX[2]+2,3,_colWidth[3],16),new MAssetLabel(LanguageManager.getWord("ssztl.common.petFight"),MAssetLabel.LABEL_TYPE_TITLE2)));
