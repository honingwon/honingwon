package sszt.scene.components.shenMoWar.clubWar
{
	...
	public class ClubPointWarIconView extends Sprite
	{
		public var _countDown:CountDownView;
		private var _mediator:SceneWarMediator;
		private var _clubWarIcon:Bitmap;
		public function ClubPointWarIconView(argMediator:SceneWarMediator)
		{
			super();
		...
		private function initView():void
		{
			...
			var t:BitmapData = AssetUtil.getAsset("mhsm.scene.ClubWarIconAsset") as BitmapData;
			if(t)
			{
		...
		private function iconClickHandler(e:MouseEvent):void
		{
			...
			{
				_mediator.showShenMoMainPanel(1);
			}
		}
