package sszt.mergeServer.components
{
	...
	import sszt.mergeServer.components.item.ShopItem;
...
//		private var _icon3:Bitmap;
		...
		public function initView():void
		{
			...
			addChild(_txtTitle);
			_txtTitle.setHtmlValue(LanguageManager.getWord("ssztl.mergeServer.acName3"));
			...
			addChild(_txtDetail);
			_txtDetail.setHtmlValue(LanguageManager.getWord("ssztl.mergeServer.acDetail3"));
