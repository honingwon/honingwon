package sszt.firebox.components.btn
{
	...
	public class MFireBoxCacheSearchSelectBtn extends MSelectButton
	{
		...
		private static const _classes:Array = [SearchBtnAsset];
		private static const _sizes:Array = [new Point(17,17)];
		private var _type:int;
		private var _xscaleType:int;
		
		public function MFireBoxCacheSearchSelectBtn(type:int,xscaleType:int)
		{
			_type = type;
