package sszt.rank.components.views.copy
{
	...
	import sszt.rank.components.itemView.copy.MultiDefenceRankItemView;
	...
	public class MultiDefenceRankView extends RankViewImpl
	{
		...
		public function MultiDefenceRankView(rankInfos:RankInfo)
		{
			super();
		...
		{
			var itemView:MultiDefenceRankItemView;
			...
			{
				itemView = new MultiDefenceRankItemView(list[i]);
		...
		{
			curItemChange(evt.currentTarget as MultiDefenceRankItemView);
		}
		
		private function curItemChange(item:MultiDefenceRankItemView):void
		{
			item.select = true;
		}
		...
		override public function dispose():void
		{
			...
			if(_resultViewList)
			{
				for each(var itemView:MultiDefenceRankItemView in _resultViewList)
				{
					itemView.dispose();	
					itemView = null;
				}
