...
handle(disband_guild, {GuildId}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40002:16,GuildID:64>>),
    gen_tcp:send(Socket, <<MsgLen:16,40002:16,GuildID:64>>),
    ok;%rec(Socket);
...
handle(confirm_disband_guild, {GuildId, ConfirmResult}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40003:16,GuildID:64,ConfirmResult:16>>),
    gen_tcp:send(Socket, <<MsgLen:16,40003:16,GuildID:64,ConfirmResult:16>>),
    ok;%rec(Socket);

%%申请氏族
handle(apply_guild, {GuildId}, Socket) ->
    io:format("client send: apply_guild Cmd=[40004], GuildId=[~p] ~n", [GuildId]),
    MsgLen = byte_size(<<1:16,40004:16,GuildID:64>>),
    gen_tcp:send(Socket, <<MsgLen:16,40004:16,GuildID:64>>),
    ok;%rec(Socket);
...
handle(response_invite, {GuildId, Response}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40007:16,GuildID:64, Response:16>>),
    gen_tcp:send(Socket, <<MsgLen:16,40007:16,GuildID:64, Response:16>>),
    ok;%rec(Socket);
...
handle(quit_guild, {GuildId}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40009:16,GuildID:64>>),
    gen_tcp:send(Socket, <<MsgLen:16,40009:16,GuildID:64>>),
    ok;%rec(Socket);
...
handle(list_member, {GuildId, PageSize, PageNo}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40011:16,GuildID:64, PageSize:16, PageNo:16>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40011:16, GuildID:64, PageSize:16, PageNo:16>>),
    ok;%rec(Socket);
...
handle(list_apply, {GuildId, PageSize, PageNo}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40012:16,GuildID:64, PageSize:16, PageNo:16>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40012:16, GuildID:64, PageSize:16, PageNo:16>>),
    ok;%rec(Socket);
...
handle(guild_info, {GuildId}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40014:16,GuildID:64>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40014:16, GuildID:64>>),
    ok;%rec(Socket);
...
handle(modify_guild_announce, {GuildId, Announce}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40016:16,GuildID:64, NameLen:16,"新氏族公告">>),
    gen_tcp:send(Socket, <<MsgLen:16, 40016:16, GuildID:64, NameLen:16, "新氏族公告">>),
    ok;%rec(Socket);

%%招募贤士信息
handle(recruit_member, {GuildId}, Socket) ->
    io:format("client send: recruit_member Cmd=[40014], GuildId=[~p] ~n", [GuildId]),
    MsgLen = byte_size(<<1:16,40016:16,GuildID:64>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40016:16, GuildID:64>>),
    ok;%rec(Socket);
...
handle(donate_money, {GuildId, Num}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40019:16,GuildID:64, Num:32>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40019:16, GuildID:64, Num:32>>),
    ok;%rec(Socket);
...
%%捐献建设卡
 handle(donate_contribution_card, {GuildId, Num}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40020:16,GuildID:64, Num:32>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40020:16, GuildID:64, Num:32>>),
    ok;%rec(Socket);
...
handle(list_donate, {GuildId, PageSize, PageNo}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40021:16,GuildID:64, PageSize:16, PageNo:16>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40021:16, GuildID:64, PageSize:16, PageNo:16>>),
    ok;%rec(Socket);

%%辞去官职
handle(resign_position, {GuildId}, Socket) ->
    io:format("client send: resign_position Cmd=[40022], GuildId=[~p] ~n", [GuildId]),
    MsgLen = byte_size(<<1:16,40022:16,GuildID:64>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40022:16, GuildID:64>>),
    ok;%rec(Socket);

%%领取日福利
handle(get_paid, {GuildId}, Socket) ->
    io:format("client send: get_paid Cmd=[40023], GuildId=[~p] ~n", [GuildId]),
    MsgLen = byte_size(<<1:16,40023:16,GuildID:64>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40023:16, GuildID:64>>),
    ok;%rec(Socket);
...
handle(get_member_info, {GuildId, PlayerId}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40024:16,GuildID:64, PlayerId:32>>),
    gen_tcp:send(Socket, <<MsgLen:16, 40024:16, GuildID:64, PlayerId:32>>),
    ok;%rec(Socket);
...
handle(give_title, {GuildId, PlayerId, Title}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40025:16,GuildID:64, PlayerId:32, TitelLen:16, "打虎英雄">>),
    gen_tcp:send(Socket, <<MsgLen:16, 40025:16, GuildID:64, PlayerId:32, TitelLen:16, "打虎英雄">>),
    ok;%rec(Socket);
...
handle(modify_remark, {GuildId, Title}, Socket) ->
    ...
    MsgLen = byte_size(<<1:16,40026:16,GuildID:64, TitelLen:16, "个人备注">>),
    gen_tcp:send(Socket, <<MsgLen:16, 40026:16, GuildID:64, TitelLen:16, "个人备注">>),
    ok;%rec(Socket);
