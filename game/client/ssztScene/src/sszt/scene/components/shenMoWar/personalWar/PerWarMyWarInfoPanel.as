package sszt.scene.components.shenMoWar.personalWar
{
	...
	import sszt.scene.components.shenMoWar.personalWar.myWar.PerWarAttackInfoTabPanel;
	import sszt.scene.components.shenMoWar.personalWar.myWar.PerWarBeAttackedInfoTabPanel;
	
	public class PerWarMyWarInfoPanel extends MPanel
	{
		...
		public function PerWarMyWarInfoPanel(argMediator:SceneWarMediator)
		{
		...
		override protected function configUI():void
		{
			...
			_btns = [];
			_classes = [PerWarAttackInfoTabPanel,PerWarBeAttackedInfoTabPanel];
			_panels = [];
